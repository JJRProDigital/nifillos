...
### 1. Editorial / thesis (8-10 slides)
...
**Slide flow:**
1. **Cover** — "X [cosas/consejos/herramientas] para [resultado]". Bold number + clear promise.
...
3. **Recap/CTA** — Optional summary of all items in a visual checklist. CTA: "Guárdalo para consultarlo después" or "Compártelo con quien lo necesite."

---

### 3. Tutorial / step-by-step (8-12 slides)

**Goal:** Teach a process. Drives saves (people bookmark to follow later).
**Best for:** How-to guides, recipes, setup guides, workflows.

**Slide flow:**
1. **Cover** — Show the finished result or outcome first. Bold title: "Cómo [resultado] en X pasos."
2. **Steps (6-10 slides)** — One step per slide. Headline: "Paso X: [acción]". Supporting text explains the detail. Use screenshots, diagrams, or process photos.
3. **Result** — Show the final outcome again with a before/after or summary.
4. **CTA** — "Guarda este tutorial" or "Comenta si te funcionó."

---

### 4. Myth vs reality (6-10 slides)
...
**Slide flow:**
1. **Cover** — "X mitos sobre [tema] en los que aún crees." Bold, confrontational.
...
3. **Synthesis** — "Lo que realmente funciona es..." with a clear takeaway.
4. **CTA** — "¿Qué mito te sorprendió más? Comenta abajo."

---

### 5. Before and after (6-8 slides)
...
**Slide flow:**
1. **Cover** — Teaser of the transformation. "De [mal estado] a [buen estado]" or dramatic before/after split.
...
5. **CTA** — "¿Quieres este resultado? Enlace en la bio" or "Guárdalo como referencia."

---

### 6. Storytelling / narrative (8-10 slides)
...
**Slide flow:**
1. **Cover** — Hook that creates curiosity. "Cómo logré [resultado sorprendente]" or "La historia detrás de [X]."
...
6. **CTA** — "¿Te ha pasado algo parecido?" or "Compártelo con quien deba escucharlo."

---

### 7. Problem → solution (6-10 slides)
...
**Slide flow:**
1. **Cover** — State the problem boldly. "¿Sigues cometiendo [error común]?" or "El problema que nadie comenta sobre [tema]."
2. **Problem (2-3 slides)** — Describe the pain. One symptom or consequence per slide. Make the reader feel seen.
3. **Bridge (1 slide)** — "Pero hay una forma mejor" or "La solución es más simple de lo que parece."
...
6. **CTA** — "Guárdalo y aplícalo hoy" or "Comenta [keyword] y te envío la guía."
...
```
=== FORMAT ===
[Name of the chosen carousel format: Editorial, Listicle, Tutorial, Myth vs reality, Before and after, Storytelling, or Problem → solution]
