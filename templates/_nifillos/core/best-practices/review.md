...
1. **Evaluate against defined criteria, never personal preference.** The quality criteria file or cuadrilla brief is the source of truth. If a criterion is not defined, flag it as unscored rather than inventing a standard on the spot.
...
1. **Load quality criteria and reference materials.** Before reading the content, review the quality-criteria file, brand guidelines, style guides, and any cuadrilla-specific evaluation rubric. Understand what "good" looks like before evaluating.
...
- [ ] **All defined criteria are covered.** Every criterion from the quality-criteria file or cuadrilla brief has been evaluated and scored. None are skipped.
