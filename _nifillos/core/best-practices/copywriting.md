...
- **Missing accents in Spanish copy**: Always write with full diacritics. Copy without accents reads as broken text and signals low quality to native speakers.
