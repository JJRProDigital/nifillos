...
Read the company context file, any upstream agent output (copywriter text, strategist direction), and the cuadrilla configuration. Identify the target platform, content format (single image, carousel, story), and the text content to be visualized.
